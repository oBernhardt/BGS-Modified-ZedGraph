...
namespace ZedGraph {
    ...
    public class BoxObj : GraphObj, ICloneable, ISerializable {
        ...
        public BoxObj(double x, double y, double width, double height, Color borderColor, Color fillColor, double rotationDegree) : this(x, y, width, height, borderColor, fillColor) {
        ...
        protected void finishRotate(Graphics g, PaneBase pane, double degree, RectangleF location) {
            g.ResetTransform();
        }
