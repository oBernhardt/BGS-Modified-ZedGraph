...
namespace ZedGraph {
    ...
    public class FontSpec : ICloneable, ISerializable {
        ...
        /// font sizes, etc. according to the actual size of the graph.
        /// </param>
        public RectangleF Draw(Graphics g, PaneBase pane, string text, float x,
            float y, AlignH alignH, AlignV alignV,
            float scaleFactor) {
            return this.Draw(g, pane, text, x, y, alignH, alignV,
        ...
        public RectangleF Draw(Graphics g, PaneBase pane, string text, float x,
            ...
            RectangleF rectDrawn = new RectangleF(x - (sizeF.Width * 0.5f), y - (sizeF.Height)*0.75f, sizeF.Width, sizeF.Height* 1.5f);
