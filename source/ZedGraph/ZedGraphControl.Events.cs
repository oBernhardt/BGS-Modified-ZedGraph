    ...
    partial class ZedGraphControl {
        ...
        protected void SetCursor(Point mousePt) {
            if (_masterPane != null) {
                ...
                if ((_isEnableHPan || _isEnableVPan) && (Control.ModifierKeys == Keys.Shift || _isPanning) && pane != null || _isPanning) {
                    this.Cursor = Cursors.Hand;
                } else if ((_isEnableVZoom || _isEnableHZoom) && (pane != null || _isZooming)) {
                    this.Cursor = Cursors.Cross;
                } else if (_isEnableSelection && (pane != null || _isSelecting)) {
                    this.Cursor = Cursors.Cross;
                } else if (this.GraphPane != null && this.GraphPane.Title.ClickAction != null && this.GraphPane.isOverTitle(mousePt.X, mousePt.Y)) {
                    this.Cursor = Cursors.Hand;
                } else {
        ...
        protected void ZedGraphControl_MouseClick(object sender, MouseEventArgs e) {
            if (_masterPane != null) {
                ...
                if (pane != null && pane.Title.ClickAction != null && pane.isOverTitle(mousePt.X, mousePt.Y)) {
                    pane.Title.ClickAction();
                }
            }
        }
